...
public class FilmsDAO implements IFilmsDao {
    ...
    public Film create(Film entity) throws DuplicateKeyException {
        ...
        try {
            ...
            PreparedStatement statement = connection.prepareStatement("INSERT INTO amt_films (ID, TITLE, RUNNING_TIME, PATH_TO_MOVIE_POSTER, DIRECTOR) VALUES (?,?,?,?,?)");
    ...
    public Film findById(String id) throws KeyNotFoundException {
        ...
        try {
            connection = dataSource.getConnection();
            PreparedStatement statement = connection.prepareStatement("SELECT ID, TITLE, RUNNING_TIME, PATH_TO_MOVIE_POSTER, DIRECTOR FROM amt_films WHERE ID = ?");
    ...
    public void update(Film entity) throws KeyNotFoundException {
        ...
        try {
            connection = dataSource.getConnection();
            PreparedStatement statement = connection.prepareStatement("UPDATE amt_films SET TITLE=?, RUNNING_TIME=?, PATH_TO_MOVIE_POSTER=?, DIRECTOR=? WHERE ID = ?");
