...
INSERT INTO `Player`(`pseudo`,`name`,`team_id`) VALUES
    ('stanislaw','Peter Jarguz',1),
    ('tarik','Tarik Celik',1),
    ('Brehze','Vincent Cayonte',1),
    ('Ethan','Ethan Arnold',1),
    ('CeRq','Tsvetelin Dimitrov',1),
    ('Xyp9x','andreas Hojsleth',2),
    ('dupreeh','PeterRasmussen',2),
    ('gla1ve','Lukas Rossander',2),
    ('device','Nicolai Reedtz',2),
    ('Magisk','Emil Reif',2),
    ('flusha','Robin Ronnquist',3),
    ('JW','Jesper Wecksell',3),
    ('KRIMZ','Freddy Johansson',3),
    ('Golden','Maikil Selim',3),
    ('Brollan','Ludvig Brolin',3),
    ('nitr0','Nick Cannella',4),
    ('NAF','Keith Markovic',4),
    ('EliGE','Jonathn Jablonowski',4),
    ('Stewie2K','Jake yip',4),
    ('Twistzz','Russel Van Dulken',4),
    ('shox','Richard Papillon',5),
    ('RpK','Cedric Guipouy',5),
    ('aPEX','Dan Madesclaire',5),
    ('ALEX','Alex McMeekin',5),
    ('ZywOo','Mathieu Herbaut',5),
    ('GUINESS','GUINESS',1),
    ('WAHLBERG','WAHLBERG',1),
    ('CHASE','CHASE',1),
    ('DAVIS','DAVIS',1),
