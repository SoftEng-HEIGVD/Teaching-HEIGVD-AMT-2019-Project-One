                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="./register">
                            ...
                            <div class="form-group">
                                <input type="password" name="password1" class="form-control form-control-user" placeholder="Mot de passe">
                            </div>
                            <div class="form-group">
                                <input type="password" name="password2" class="form-control form-control-user" placeholder="Répétez Mot de Passe">
                            </div>
